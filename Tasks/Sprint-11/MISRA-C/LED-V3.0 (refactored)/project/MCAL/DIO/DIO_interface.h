 ...
 * @return error status
 */
extern en_DIO_errorState_t DIO_SetPinDir(en_port_t Copy_Port, en_pin_t Copy_Pin, en_pinDirection_t Copy_Dir);
 ...
 * @return error status
 */
extern en_DIO_errorState_t DIO_SetPortDir(en_port_t Copy_Port, uint8_t_ Copy_Dir);
 ...
 * @return error status
 */
extern en_DIO_errorState_t DIO_SetPinVal(en_port_t Copy_Port, en_pin_t Copy_Pin, en_pinValue_t Copy_Value);
 ...
 * @return error status
 */
extern en_DIO_errorState_t DIO_SetPortVal(en_port_t Copy_Port, uint8_t_ Copy_Value);
 ...
 * @return error status
 */
extern en_DIO_errorState_t DIO_GetPinVal(en_port_t Copy_Port, en_pin_t Copy_Pin, uint8_t_* Copy_pu8Val);
 ...
 * @return error status
 */
extern en_DIO_errorState_t DIO_TogglePin(en_port_t Copy_Port, en_pin_t Copy_Pin);
 ...
 * @return error status
 */
extern en_DIO_errorState_t DIO_MaskPortVal(en_port_t Copy_Port, uint8_t_ Copy_portMask, en_pinValue_t Copy_Value);
